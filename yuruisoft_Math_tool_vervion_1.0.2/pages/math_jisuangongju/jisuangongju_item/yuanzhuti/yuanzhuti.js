...
click_jisuan: function(){
  ...
  {                
      var _result_1 = Math.PI*Math.pow(Number(this.data._r_value),2)*Number(this.data._h_value); 
      var _result_2 = 2*Math.PI*Number(this.data._r_value)*Number(this.data._h_value);
      this.setData({
          result_1:_result_1,
          result_2:_result_2,
          error:false
